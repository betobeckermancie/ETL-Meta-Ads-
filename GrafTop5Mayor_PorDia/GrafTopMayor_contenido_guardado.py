...
#convertimos el resultado en un dataframe para el formato tabla
top5ads_df = top_5_ads.reset_index()
top5ads_df.columns =["nombre_anuncio", variable_analizar]

#imprimimos el top 5 nombre y cantidad en formato tabla
print("Top 5 con Mayor numero de", variable_analizar)
