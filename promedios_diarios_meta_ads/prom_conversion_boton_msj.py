...
# Calcular el promedio de conversion al boton de mensaje en el dia (evitando la división por 0)
df['clicks_por_dia'] = df['conversion_boton_msj'] / df['dias_duracion'].replace(0, 1)

# Agrupar por nombre de anuncio y calcular el promedio de conversion al boton de mensaje
...
plt.title('Promedio de conversion al boton de mensaje', fontsize=16)
