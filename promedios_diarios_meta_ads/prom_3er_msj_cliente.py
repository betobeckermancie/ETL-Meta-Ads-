...
# Calcular el promedio del 3er msj por usuario al dia (evitando la división por 0)
df['clicks_por_dia'] = df['3er_msj_cliente'] / df['dias_duracion'].replace(0, 1)

# Agrupar por nombre de anuncio y calcular el promedio de 3er msj por usuario al dia
...
plt.title('Promedio del 3er msj por usuario al dia', fontsize=16)
