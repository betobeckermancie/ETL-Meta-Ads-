...
# Calcular el promedio de reacciones en ad al dia (evitando la división por 0)
df['clicks_por_dia'] = df['reacciones_post'] / df['dias_duracion'].replace(0, 1)

# Agrupar por nombre de anuncio y calcular el promedio de reacciones en anuncio al dia
...
plt.title('Promedio de reacciones en Anuncio por Dia', fontsize=16)
