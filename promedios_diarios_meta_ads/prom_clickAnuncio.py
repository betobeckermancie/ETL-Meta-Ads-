...
# Calcular el promedio de clicks por día (evitando la división por 0)
df['clicks_por_dia'] = df['clicks_en_anuncio'] / df['dias_duracion'].replace(0, 1)

# Agrupar por nombre de anuncio y calcular el promedio de clicks por día
...
plt.title('Promedio de Clicks al Dia en Anuncio', fontsize=16)
