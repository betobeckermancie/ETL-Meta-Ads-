...
# Calcular el promedio de conversion primer respuesta en el dia (evitando la división por 0)
df['clicks_por_dia'] = df['conversion_primer_respuesta'] / df['dias_duracion'].replace(0, 1)

# Agrupar por nombre de anuncio y calcular el promedio de conversion primer respuesta
...
plt.title('Promedio de conversion primer respuesta', fontsize=16)
