...
# Calcular el promedio de costo por mil impresiones al dia (evitando la división por 0)
df['clicks_por_dia'] = df['costo_por_mil_impresiones'] / df['dias_duracion'].replace(0, 1)

# Agrupar por nombre de anuncio y calcular el promedio de costo por resultado
...
plt.title('Promedio de Costo por mil impresiones', fontsize=16)
