...
# Calcular el promedio de vistas en msj de bienvenida (evitando la división por 0)
df['clicks_por_dia'] = df['vistas_mensaje_bienvenida'] / df['dias_duracion'].replace(0, 1)

# Agrupar por nombre de anuncio y calcular el promedio de vistas en msj de bienvenida
...
plt.title('Promedio de vistas en msj de bienvenida al dia', fontsize=16)
