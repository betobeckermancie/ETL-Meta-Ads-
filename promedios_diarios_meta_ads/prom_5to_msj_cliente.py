...
# Calcular el promedio diario de 5to msj del cliente (evitando la división por 0)
df['clicks_por_dia'] = df['5to_msj_cliente'] / df['dias_duracion'].replace(0, 1)

# Agrupar por nombre de anuncio y calcular el promedio de 5to msj al cliente diario
...
plt.title('Promedio diario de 5to msj del cliente', fontsize=16)
