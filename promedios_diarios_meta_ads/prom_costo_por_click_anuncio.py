...
#Calcular el promedio de costo por click por dia(evitando dividir entre 0)
df['clicks_por_dia']= df['click_enlace_trafico']/df['dias_duracion'].replace(0,1)

#Agrupar por nombre de anuncio y calcular el promedio de costo por click
...
plt.title('Promedio de costo por click en anuncio', fontsize=16)
