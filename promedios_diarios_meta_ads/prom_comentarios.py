...
# Calcular el promedio de comentarios por usuario al dia (evitando la división por 0)
df['clicks_por_dia'] = df['comentarios'] / df['dias_duracion'].replace(0, 1)

# Agrupar por nombre de anuncio y calcular el promedio de comentarios por usuario al dia
...
plt.title('Promedio de comentarios por usuario al dia', fontsize=16)
