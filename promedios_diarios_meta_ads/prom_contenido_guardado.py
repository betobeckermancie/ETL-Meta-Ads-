...
# Calcular el promedio de contenido guardado por usuario al dia (evitando la división por 0)
df['clicks_por_dia'] = df['contenido_guardado'] / df['dias_duracion'].replace(0, 1)

# Agrupar por nombre de anuncio y calcular el promedio de contenido guardado por usuario al dia
...
plt.title('Promedio de contenido guardado por usuario al dia', fontsize=16)
