...
# Calcular el promedio de interaccion en la pagina por dia (evitando la división por 0)
df['clicks_por_dia'] = df['interaccion_page'] / df['dias_duracion'].replace(0, 1)

# Agrupar por nombre de anuncio y calcular el promedio de interaccion en pagina
...
plt.title('Promedio de interaccion en pagina por dia', fontsize=16)
