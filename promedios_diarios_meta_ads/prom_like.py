...
# Calcular el promedio de likes al dia (evitando la división por 0)
df['clicks_por_dia'] = df['like'] / df['dias_duracion'].replace(0, 1)

# Agrupar por nombre de anuncio y calcular el promedio de likes al dia
...
plt.title('Promedio de likes al dia', fontsize=16)
