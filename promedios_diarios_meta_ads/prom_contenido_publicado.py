...
# Calcular el promedio de contenido publicado por usuario al dia (evitando la división por 0)
df['clicks_por_dia'] = df['contenido_publicado'] / df['dias_duracion'].replace(0, 1)

# Agrupar por nombre de anuncio y calcular el promedio de contenido publicado por usuario al dia
...
plt.title('Promedio de contenido publicado por usuario al dia', fontsize=16)
