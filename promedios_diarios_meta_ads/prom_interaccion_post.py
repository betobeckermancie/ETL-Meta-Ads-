...
# Calcular el promedio de interaccion en el post por dia (evitando la división por 0)
df['clicks_por_dia'] = df['interaccion_post'] / df['dias_duracion'].replace(0, 1)

# Agrupar por nombre de anuncio y calcular el promedio de interaccion en el post
...
plt.title('Promedio de interaccion en post por dia', fontsize=16)
