...
# Calcular el promedio de costo por resultado en el dia (evitando la división por 0)
df['clicks_por_dia'] = df['costo_por_resultado'] / df['dias_duracion'].replace(0, 1)
...
plt.title('Promedio de Costo por resultado', fontsize=16)
