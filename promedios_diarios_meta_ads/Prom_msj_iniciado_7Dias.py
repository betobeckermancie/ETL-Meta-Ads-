...
# Calcular el promedio de msj iniciado en 7 dias (evitando la división por 0)
df['clicks_por_dia'] = df['msj_iniciado_7Dias'] / df['dias_duracion'].replace(0, 1)

# Agrupar por nombre de anuncio y calcular el promedio de msj iniciado en 7 dias
...
plt.title('Promedio de msjs enviados en 7 dias por Dia', fontsize=16)
