...
# Calcular el promedio de vistas de video al dia (evitando la división por 0)
df['clicks_por_dia'] = df['vistas_video'] / df['dias_duracion'].replace(0, 1)
...
plt.title('Promedio de vistas de video por Dia', fontsize=16)
